  ...
  return (
    <section className="relative mt-12 overflow-hidden bg-gray-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-12 mt-12 flex items-center justify-center gap-8">
          {countries.map(country => (
            <div
              key={country.code}
              className="flex items-center gap-3 rounded-xl bg-white px-6 py-4 shadow-md transition-shadow duration-200 hover:shadow-lg"
            >
              <Image
                src={country.flagUrl}
        ...
        <div className="rounded-xl bg-white p-6 shadow-md transition-shadow duration-200 hover:shadow-lg">
        ...
        <div className="mb-12 mt-12 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          {countries.map(country => (
            <div
              key={country.code}
              className="space-y-4 rounded-xl bg-white p-6 shadow-md transition-shadow duration-200 hover:shadow-lg"
            >
