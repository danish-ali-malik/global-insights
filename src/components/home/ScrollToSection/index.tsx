...
export const ScrollToSection = ({ 
  ...
  return (
    <button
      ...
      className={`absolute bottom-8 left-0 right-0 mx-auto flex w-fit animate-bounce flex-col items-center cursor-pointer transition-colors duration-200 hover:text-gray-600 ${className}`}
